...
#include "ros2_unitree_legged_msgs/msg/detail/bms_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_unitree_legged_msgs::msg::BmsState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs::msg::BmsState & ros_message)
{
  // Member: version_h
  cdr >> ros_message.version_h;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_unitree_legged_msgs::msg::BmsState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_unitree_legged_msgs::msg::BmsState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_unitree_legged_msgs::msg::BmsState *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_unitree_legged_msgs::msg::BmsState>()
{
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_BmsState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_unitree_legged_msgs, msg, BmsState)() {
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_BmsState__handle;
}
