...
#include "ros2_unitree_legged_msgs/msg/detail/cartesian__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_unitree_legged_msgs::msg::Cartesian & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs::msg::Cartesian & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_unitree_legged_msgs::msg::Cartesian;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_unitree_legged_msgs::msg::Cartesian *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_unitree_legged_msgs::msg::Cartesian *>(
    untyped_ros_message);
...
static size_t _Cartesian__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Cartesian(full_bounded, is_plain, 0);
...
{
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_Cartesian__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_unitree_legged_msgs, msg, Cartesian)() {
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_Cartesian__handle;
}
