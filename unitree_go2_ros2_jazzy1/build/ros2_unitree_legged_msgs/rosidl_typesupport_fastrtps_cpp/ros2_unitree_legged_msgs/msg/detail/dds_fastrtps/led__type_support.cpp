...
#include "ros2_unitree_legged_msgs/msg/detail/led__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_unitree_legged_msgs::msg::LED & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs::msg::LED & ros_message)
{
  // Member: r
  cdr >> ros_message.r;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_unitree_legged_msgs::msg::LED;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_unitree_legged_msgs::msg::LED *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_unitree_legged_msgs::msg::LED *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros2_unitree_legged_msgs::msg::LED>()
{
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_LED__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_unitree_legged_msgs, msg, LED)() {
  return &ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_LED__handle;
}
