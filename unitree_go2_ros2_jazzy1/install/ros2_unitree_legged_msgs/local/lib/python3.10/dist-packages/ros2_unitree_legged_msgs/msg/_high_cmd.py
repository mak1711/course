    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_unitree_legged_msgs.msg.HighCmd')
            logger.debug(
            ...
            from ros2_unitree_legged_msgs.msg import LED
...
class HighCmd(metaclass=Metaclass_HighCmd):
    ...
    _fields_and_field_types = {
        ...
        'led': 'ros2_unitree_legged_msgs/LED[4]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['ros2_unitree_legged_msgs', 'msg'], 'LED'), 4),  # noqa: E501
