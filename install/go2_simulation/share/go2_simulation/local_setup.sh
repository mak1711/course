...
: ${AMENT_CURRENT_PREFIX:="/home/kan/lab/course/install/go2_simulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_simulation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_simulation/environment/path.sh"
